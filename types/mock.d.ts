...
export declare const asyncFetchAdditionalData: (
  verifiedRequest: VerifiedRequestType,
  options?: {
    age: number;
  },
) => Promise<WithAdditionalDataType>;
export declare const asyncFetchAdditionalDataWithError: (
...
export declare const generateMatches: (ms: { names: string[]; matched: boolean[]; age?: number[] }) => any;
